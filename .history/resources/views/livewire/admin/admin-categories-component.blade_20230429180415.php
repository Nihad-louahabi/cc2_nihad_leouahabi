                            ...
                            <div class ="card">
                                <div class ="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">       <a href="{{route('admin.category.add' )}} " class="btn btn-success float-end">Add New Category</a>
                                        </div>
                                </div>
                                <div class ="card-body">
                                    ...
                                    <table class="table tabel-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- {{route('admin.category.edit',['category_id'=>$category->id])}} --}}
