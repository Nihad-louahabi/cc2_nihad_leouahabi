...
class UserOrdersComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.user.user-orders-component',['orders'=>$orders,'totalCost'=>$totalCosttotalPurchase'=>$totalPurchase,'totalDelivered'=>$totalDelivered,'totalCanceled'=>$totalCanceled]);
    }
}
