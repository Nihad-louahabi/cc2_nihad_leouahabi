...
class UserOrdersComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.user.user-orders-component',['orders'=>$orders,'totalCost'=>$totalPurchase'=>$totalPurchase,'totalDelivered'=>$totalDelivered,'totalCanceled'=>$totalCanceled]);
    }
}
